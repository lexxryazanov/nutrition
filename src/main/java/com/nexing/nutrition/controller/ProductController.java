...
public class ProductController {
    ...
    public @ResponseBody
    Iterable<Product> getProducts(@RequestParam(name = "keyword", required = false) String keyword, @RequestParam(name = "page", defaultValue = "0") Integer page, @RequestParam(name = "size", defaultValue = "100") Integer size) {
